...
// ********* HARDWARE ***********
// --dms-get-manufacturer      | Quectel |
// --dms-get-model             | EP 06 |
// --dms-get-ids               | IMEI |
// --dms-get-software-version  | FIEMWARE VERSION |
// --dms-uim-get-iccid         | ICCID |
// ********** NETWORK **********
// --nas-get-home-network      | MCC MNC COPS -> maybe unused |
// --nas-get-signal-info       | LTE, RSSI, RSRQ, RSRP, SNR |
